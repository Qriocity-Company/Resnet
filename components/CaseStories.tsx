            ...
            <div className="flip-card-back rounded-xl relative" style={clicked0?{display:'block'}:{}}>
              ...
              <div className={`block md:flex gap-5 h-full w-full ${!clicked0? 'max-h-[450px]':''} overflow-hidden `}>
                ...
                <div className='w-full md:w-[100%] '>
                  <h1 className='mt-2 md:mt-0 text-xl lg:text-2xl font-bold text-transparent bg-gradient-to-r from-[#FF001D] from-40% via-purple-800 via-60% to-blue-700 to-100% bg-clip-text'>Redefining Student Projects</h1>
                  ...
                  <div className=' lg:text-lg'>
                    <h2 className='mt-3 text-left text-base lg:text-xl font-bold text-[#FF001D]'>ResNet&apos;s Impact on Student Projects</h2>
                    ...
                    <h2 className='hidden md:block mt-3 text-left text-base lg:text-xl font-bold text-[#FF001D]'>Qriocity.in: Beyond Academics with ResNet</h2>
