        ...
        <div className='modal-inner relative rounded-[30px] w-[90%] md:w-auto  h-[50vh] md:h-auto'>
            ...
            <form className="form-container z-30 absolute left-0 top-0 h-full w-full flex flex-col gap-2 justify-center items-center" onSubmit={onSubmit}>
              ...
              <div className="form-component w-[70%] flex items-center gap-2">
                ...
                <input type="text" name="name" placeholder="Your Name" className="bg-transparent border-b-white border-b-2 p-2 mb-2 outline-none w-full md:text-base text-sm" required/>
              </div>
              <div className="form-component w-[70%] flex items-center gap-2">
                <Image src={email} alt='Email' height={40} className="h-[20px] md:h-[40px]"></Image>
                <input type="email" name="senderEmail" placeholder="Your Email" className="bg-transparent border-b-white border-b-2 p-2 mb-2 outline-none w-full md:text-base text-sm" required/>
              </div>
              <div className="form-component w-[70%] flex items-center gap-2">
                <Image src={phone} alt='Name' height={40} className="h-[20px] md:h-[40px]"></Image>
                <input type="number" name="Phonenumber" placeholder="Your Phone Number" className="bg-transparent border-b-white border-b-2 p-2 mb-2 outline-none w-full md:text-base text-sm" required/>
              </div>
              <div className="form-component w-[70%] flex items-center gap-2">
                
                <textarea name="message" placeholder="Message" className="bg-transparent border-b-white border-b-2 p-2 mb-2 outline-none w-full resize-none md:text-base text-sm" required/>
              </div>
